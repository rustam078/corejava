...
public class LocalDateInbuiltMethod1 {

	public static void main(String[] args) {

		System.out.println("/********************************************/");
		LocalDate ldate = LocalDate.parse("2022-02-28");
		LocalDateTime startOfDay = ldate.atStartOfDay();
		System.out.println(ldate);
		System.out.println(startOfDay);// the local date-time of midnight at the start of this date, not null
		LocalDateTime atTime = ldate.atTime(10, 10, 10); // Combines this date with a time to create a
															// LocalDateTime.
		System.out.println(atTime);

		LocalDate sydneytime = LocalDate.now(ZoneId.of("Australia/Sydney"));
		...
		System.out.println(ldate.lengthOfMonth());
		System.out.println(ldate.lengthOfYear());
