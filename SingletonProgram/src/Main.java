...
public class Main {
    ...
    private static void exampleSerialization() throws IOException, ClassNotFoundException {
        ...
        LazySingleton lazySingleton2 = LazySingleton.getInstance();  //it will return same object ref
        System.out.println("Object 1 :" + lazySingleton.hashCode()+" Object 2 :" + lazySingleton2.hashCode());
        ...
        //but here not changed because of override readResolve method because during deserialized jvm will automatic call this method 
