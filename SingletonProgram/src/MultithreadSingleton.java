 ...
 * there are 3 thread t1 is inside getinstance and t2,t3 waiting. Now t2 will get into method and 
 * simply return instance created by t1 and t3 still waiting. 
    ...
    public static MultithreadSingleton getInstance() {
        ...
        if(instance == null) {
            ...
            synchronized (MultithreadSingleton.class) {
                //Reason for second null check is lets say two thread are come inside first null at same time
